...
{   // Модальное окно
    ...
    const handlerModal = (openBtn, modal, openSelector, closeBtn, sk) => {
    ...
    handlerModal(presentOrderBtn, pageOverlayModal, 'page__overlay_modal_open', modalClose, 'fast');
}
...
{ // Создание карточек портфолио на основе JSON с сервера
    const COUNT_CARD = 2;
    const portfolioList = document.querySelector('.portfolio__list');
